// ќбъ€вите этот макрос в самом начале файла, чтобы при подключении <cmath> были объ€влены макросы M_PI и другие 
...
namespace shapes {
    ...
    //–еализаци€ методов и конструктора класса Triangle
    ...
    //–еализаци€ методов и конструктора класса Star
    ...
    //–еализаци€ методов и конструктора Snowman
